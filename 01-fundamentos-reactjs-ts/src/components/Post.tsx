...
export function Post({post} : PostProps) {
    const publishedAtFormatted = format(post.publishedAt, "d 'de' LLLL 'às' HH:mm'h'", {locale: ptBR});
    ...
    function deleteComment(commentToDelete: string){
        const comentsUpdated =  comments.filter(comment => {return comment != commentToDelete});
